...
public class MailUtil {
	...
	protected final LoggerAdapter logger = LoggerAdapterFacory.getLoggerAdapter(getClass());
	...
	public boolean send(Mail mail) {
		...
		try {
			...
			email.setAuthenticator(new MyAuthenticator("565372710@qq.com", "ncxrottubrpvbdff"));
	 ...
	 mail.setSender("454777430@qq.com");
	 mail.setReceiver("zous@mmfenqi.com"); // 接收人
	 mail.setUsername("565372710@qq.com"); // 登录账号,一般都是和邮箱名一样吧
	 mail.setPassword("ncxrottubrpvbdff"); // 发件人邮箱的登录密码
