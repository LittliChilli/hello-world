...
app.controller('myCtrl', function ($scope, $http, $location, $q) {
    ...
    function go_to(to) {
        ...
        var login_url = url.replace(/index.html/, to);
    ...
    $scope.index_goods_show = function () {
        ...
        var category_promise = $http.get('/singapore/goods/query_all_goods_category');
        var all_goods_promise = $http.get('/singapore/goods/query_all_goods');
    ...
    $scope.detail = function (goodsId) {
        window.location.href = "goods_detail.html?goods_id=" + goodsId;
    }
